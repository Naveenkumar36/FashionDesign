  ...
  <div class="content-wrapper">
    <div class="container">
     ...
     <div class="box box-formhead box-solid">
							...
							<g:form role="form"
								url="[resource:galleryInstance, action:'save']" enctype="multipart/form-data">
								...
								<fieldset class="buttons">
									...
									<g:link action="index" controller="gallery" class="btn btn-primary btn-sm">Cancel</g:link>
									</div>
								</fieldset>
							</g:form>
						</div>
