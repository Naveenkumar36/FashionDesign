	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.phone_No}">
				<li class="fieldcontain">
					<span id="phone_No-label" class="property-label"><g:message code="user.phone_No.label" default="Phone No" /></span>
					
						<span class="property-value" aria-labelledby="phone_No-label"><g:fieldValue bean="${userInstance}" field="phone_No"/></span>
