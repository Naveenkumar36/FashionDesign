...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="${request.contextPath}/index2.html" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="${request.contextPath}/img/user2-160x160.jpg" class="img-circle" alt="User Image" kasperskylab_antibanner="on">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="${request.contextPath}/img/user3-128x128.jpg" class="img-circle" alt="User Image" kasperskylab_antibanner="on">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="${request.contextPath}/img/user4-128x128.jpg" class="img-circle" alt="User Image" kasperskylab_antibanner="on">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${request.contextPath}/img/user2-160x160.jpg" class="user-image" alt="User Image" kasperskylab_antibanner="on">
    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="q" class="form-control" placeholder="Search..." vk_1b9ad="subscribed">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="${request.contextPath}/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="${request.contextPath}/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li><a href="${request.contextPath}/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
  ...
  <div class="content-wrapper" style="min-height: 1016px;">
            ...
            <div class="box-body">
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item">
                    <img src="http://placehold.it/900x500/39CCCC/ffffff&amp;text=I+Love+Bootstrap" alt="First slide" kasperskylab_antibanner="on">
                  ...
                  <div class="item active">
                    <img src="http://placehold.it/900x500/3c8dbc/ffffff&amp;text=I+Love+Bootstrap" alt="Second slide" kasperskylab_antibanner="on">
                  ...
                  <div class="item">
                    <img src="http://placehold.it/900x500/f39c12/ffffff&amp;text=I+Love+Bootstrap" alt="Third slide" kasperskylab_antibanner="on">
...
<!-- jQuery 2.2.0 -->
<script async="" src="//www.google-analytics.com/analytics.js"></script><script src="${request.contextPath}/plugins/jQuery/jQuery-2.2.0.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="${request.contextPath}/bootstrap/js/bootstrap.min.js"></script>
<!-- FastClick -->
<script src="${request.contextPath}/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="${request.contextPath}/js/app.min.js"></script>
